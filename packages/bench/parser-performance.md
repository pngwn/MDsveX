...
- **Favor regex sticky search for span detection.** `benchmarks/span-detection.bench.mjs` demonstrates sticky regex is **20.65× faster** than charCode scanning when locating spans.
