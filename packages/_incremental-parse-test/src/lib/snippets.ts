		...
		snippets: [
			{
				...
				slug: "inline-html",
				markdown:
					"A paragraph with <em>emphasis</em> and <strong>bold</strong> inline.\n",
			},
			{
				name: "Self-closing tags",
				slug: "self-closing",
				markdown:
					'Text with a <br /> break and <img src="photo.jpg" alt="A photo" />.\n',
			},
			{
				name: "Nested HTML",
				slug: "nested-html",
			...
			},
			{
				...
				markdown:
					'<div class="wrapper" id="main" data-active>\n\nContent inside a div.\n\n</div>\n',
			},
			{
			...
			},
			{
				...
				markdown:
					'Text before <Widget count="3" /> and after.\n\n<AlertBox type="warning">\n\n*Warning:* something important.\n\n</AlertBox>\n',
			},
		],
	},
	{
